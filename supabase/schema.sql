...
insert into stores (id, name, category, latitude, longitude, address, business_hours, phone, avg_rating, review_count, tags, updated_at) values
  ('a0000000-0000-0000-0000-000000000001', '할머니 손칼국수', '맛집', 37.4991, 127.0268, '서울 강남구 테헤란로 12길 5', '{"mon": {"open": "10:30", "close": "21:00"}, "tue": {"open": "10:30", "close": "21:00"}}', '02-1234-5678', 4.5, 812, array['혼밥가능', '웨이팅적음'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000002', '우진 삼겹살', '맛집', 37.4961, 127.0297, '서울 강남구 역삼로 33', '{"mon": {"open": "16:00", "close": "24:00"}}', '02-2345-6789', 4.3, 1560, array['주차가능', '단체가능'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000003', '정성스시', '맛집', 37.5006, 127.0291, '서울 강남구 논현로 100', '{"mon": {"open": "11:30", "close": "22:00"}}', '02-3456-7890', 4.7, 430, array['혼밥가능', '룸있음'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000004', '종로 김치찌개', '맛집', 37.4970, 127.0251, '서울 강남구 강남대로 50길 8', '{"mon": {"open": "09:00", "close": "20:00"}}', '02-4567-8901', 4.1, 980, array['가성비', '혼밥가능'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000005', '느린 오후 커피', '카페', 37.4987, 127.0287, '서울 강남구 선릉로 25길 4', '{"mon": {"open": "08:00", "close": "22:00"}}', '02-5678-9012', 4.6, 640, array['콘센트많음', '조용함'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000006', '브릭레인 로스터리', '카페', 37.4957, 127.0282, '서울 강남구 테헤란로 8길 15', '{"mon": {"open": "07:30", "close": "21:00"}}', '02-6789-0123', 4.4, 305, array['실내좌석많음', '노트북가능'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000007', '코너스톤 베이커리 카페', '카페', 37.5010, 127.0259, '서울 강남구 역삼로 61', '{"mon": {"open": "08:00", "close": "20:00"}}', '02-7890-1234', 4.2, 512, array['디저트맛집'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000008', 'GS25 강남역점', '편의점', 37.4985, 127.0272, '서울 강남구 강남대로 396', '{"mon": {"open": "00:00", "close": "24:00"}}', '02-8901-2345', 4.0, 88, array['24시간', '택배가능'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000009', 'CU 역삼점', '편의점', 37.4966, 127.0285, '서울 강남구 역삼로 44', '{"mon": {"open": "00:00", "close": "24:00"}}', '02-9012-3456', 3.9, 45, array['24시간', 'ATM있음'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000010', '강남 센트럴 백화점', '백화점', 37.5014, 127.0304, '서울 강남구 테헤란로 152', '{"mon": {"open": "10:30", "close": "20:00"}}', '02-0123-4567', 4.3, 2100, array['주차가능', '발렛가능'], '2026-07-20T09:00:00+09:00'),
  ('a0000000-0000-0000-0000-000000000011', '논현 프리미엄 아울렛', '백화점', 37.4948, 127.0257, '서울 강남구 논현로 65길 12', '{"mon": {"open": "10:30", "close": "21:00"}}', '02-1230-4560', 4.1, 760, array['주차가능'], '2026-07-20T09:00:00+09:00')
